...
class Ui_TranslateAPP(object):
    def setupUi(self, TranslateAPP):
        ...
        self.gridLayoutWidget_3.setGeometry(QtCore.QRect(3, 76, 540, 41))
        ...
        self.LanguagesBox.addWidget(self.Languages_1, 1, 2, 1, 1)
        self.Languages_2 = QtWidgets.QComboBox(self.gridLayoutWidget_3)
        self.Languages_2.setObjectName("Languages_2")
        self.LanguagesBox.addWidget(self.Languages_2, 1, 0, 1, 1)
        ...
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(140, 120, 263, 41))
