...
class Ui_TranslateAPP(object):
    def setupUi(self, TranslateAPP):
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(4, 5, 540, 62))
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(4, 107, 207, 61))
        ...
        self.gridLayout.addWidget(self.sb_time_min, 1, 1, 1, 1)
        self.sb_time_max = QtWidgets.QSpinBox(self.gridLayoutWidget)
        self.sb_time_max.setMinimum(2)
        self.sb_time_max.setMaximum(60)
        self.sb_time_max.setObjectName("sb_time_max")
        self.gridLayout.addWidget(self.sb_time_max, 1, 3, 1, 1)
